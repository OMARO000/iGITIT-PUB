      ...
      {!compareMode ? (
        ...
        <div style={{ marginBottom: "32px" }}>
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            ...
            <button suppressHydrationWarning className="analyze-btn" onClick={handleAnalyzeA} disabled={analyzingA} data-analyzing={analyzingA ? "true" : undefined} style={{ padding: "16px 32px", background: analyzingA ? "rgba(255,255,255,0.06)" : "#4A9EF0", border: "1px solid #4A9EF0", borderRadius: "6px", fontFamily: "inherit", fontSize: "18px", color: analyzingA ? "rgba(255,255,255,0.3)" : "#0b0b0c", cursor: urlA.trim() && !analyzingA ? "pointer" : "default", letterSpacing: "0.08em", whiteSpace: "nowrap", transition: "all 0.15s", animation: urlA.trim() && !analyzingA ? "pulse-btn 1.5s ease-in-out infinite" : "none" }}>
