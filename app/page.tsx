    ...
    <div style={{ minHeight: "100dvh", background: "#0b0b0c", fontFamily: "'IBM Plex Mono', 'Courier New', monospace", fontSize: "14px", color: "rgba(255,255,255,0.92)", padding: "48px 40px 120px", maxWidth: compareMode ? "1400px" : "1100px", margin: "0 auto" }}>
      <style suppressHydrationWarning>{`
        ...
        * { box-sizing: border-box; }
        ...
        .analyze-btn:disabled { background: #4A9EF0 !important; color: rgba(0,0,0,0.4) !important; }
        .analyze-btn:disabled:not([data-analyzing]) { opacity: 1 !important; }
        .analyze-btn[data-analyzing] { background: rgba(255,255,255,0.06) !important; color: rgba(255,255,255,0.3) !important; }
      ...
      {!compareMode ? (
        ...
        <div style={{ marginBottom: "32px" }}>
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            ...
            <button suppressHydrationWarning className="analyze-btn" onClick={handleAnalyzeA} style={{ padding: "16px 32px", background: analyzingA ? "rgba(255,255,255,0.06)" : "#4A9EF0", border: "1px solid #4A9EF0", borderRadius: "6px", fontFamily: "inherit", fontSize: "18px", color: analyzingA ? "rgba(255,255,255,0.3)" : "#0b0b0c", cursor: analyzingA ? "default" : "pointer", letterSpacing: "0.08em", whiteSpace: "nowrap", transition: "all 0.15s", animation: !analyzingA ? "pulse-btn 1.5s ease-in-out infinite" : "none", opacity: 1 }}>
