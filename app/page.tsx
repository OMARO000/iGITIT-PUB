    ...
    <div suppressHydrationWarning className={`scanlines igitit-wrap`} data-theme={lightMode ? "light" : "dark"} style={{ minHeight: "100dvh", fontFamily: "'IBM Plex Mono', 'Courier New', monospace", fontSize: "14px", color: T.text, padding: "48px 40px 120px", maxWidth: compareMode ? "1400px" : "1100px", margin: "0 auto", transition: "color 0.3s ease, background-color 0.3s ease" }}>
      ...
      {!compareMode ? (
        ...
        <div suppressHydrationWarning className="url-input-box" style={{ marginBottom: "32px", background: analyzingA ? "rgba(74,158,255,0.04)" : analysisA ? "rgba(10,74,53,0.5)" : undefined, border: analyzingA ? "1px solid rgba(74,158,240,0.2)" : analysisA ? "2px solid #0D7A55" : undefined, borderRadius: "8px", padding: analyzingA ? "16px" : "0", transition: "all 0.3s ease" }}>
          ...
          {/* Original GitByte during analysis; FEM GITBYTE (idle + chat) once results are in */}
            ...
            >
              ...
              <div className="fem-url-box" style={{ display: "flex", gap: "8px" }}>
                <input
                  ...
                  style={{ flex: 1, background: "rgba(0,200,150,0.04)", border: "1px solid rgba(0,200,150,0.2)", borderRadius: "5px", padding: "10px 14px", fontFamily: "inherit", fontSize: "13px", color: "rgba(255,255,255,0.88)", outline: "none", letterSpacing: "0.02em" }}
                />
                <button
                  onClick={handleRepoChatSubmit}
                  style={{ background: "rgba(0,200,150,0.12)", border: "1px solid rgba(0,200,150,0.4)", borderRadius: "5px", padding: "10px 18px", fontFamily: "inherit", fontSize: "13px", color: "#00C896", cursor: "pointer", letterSpacing: "0.08em", whiteSpace: "nowrap" }}
                >
                  [ → ]
                </button>
              </div>
              {repoChatResponse && (
                <div style={{ marginTop: "8px", fontSize: "11px", color: "rgba(0,200,150,0.65)", letterSpacing: "0.04em", fontStyle: "italic" }}>
                  → {repoChatResponse}
                </div>
              )}
              {omenNote && (
                <div style={{ marginTop: "8px", padding: "7px 10px", background: "rgba(224,92,92,0.06)", border: "1px solid rgba(224,92,92,0.2)", borderRadius: "4px", fontSize: "11px", color: "rgba(224,92,92,0.7)", lineHeight: 1.5 }}>
